...
//         children: <Widget>[
//           Container(
//             decoration: BoxDecoration(borderRadius: BorderRadius.circular(16), color: Color.fromARGB(255, 243, 229, 216)),
//             padding: EdgeInsets.all(15),
//             child: Row(
...
//                 child: Column(
//                   children: [
//                     Image.asset("assets/images/busnesmen.png"),
//                     Text(
//                       "men",
//                     ),
//                   ],
...
//                 child: Column(
//                   children: [
//                     Container(height: 70, width: 70, child: Image.asset("assets/images/ss.png")),
//                     const Text("lezyman"),
//                   ],
//                 ),
//               ),
...
//                         Navigator.push(context, MaterialPageRoute(builder: (context) => MainBody()));
//                       },
//                       icon: Course(image: "assets/images/ui.png", title: "Lerning UI/UX Designer", lessons: "24 Lesson", duration: "2Hr 30 Min")),
//                   const SizedBox(
//                     height: 20,
//                   ),
//                   IconButton(
...
//                         Navigator.push(context, MaterialPageRoute(builder: (context) => MainBody()));
//                       },
//                       icon: Course(image: "assets/icons/rocket.png", title: "Lerning Web Devolopmend", lessons: "24 Lesson", duration: "2Hr 30 Min")),
//                   const SizedBox(
//                     height: 20,
//                   ),
//                   IconButton(
